...
colorlinks: yes
bibliography:  
- ../quinoa_2017/book.bib
- ../quinoa_2017/pkgs.bib
...
## Album {style="--header-color:darkorange; --other-color-for-h2-gradient:orange;"}
...
png("../quinoa_2017/img/qr.png", width = 20, height = 20, units = "cm", res = 1200)
par(mar=c(0,0,0,0))
image(qrencode_raster("http://evoplant.uni-hohenheim.de/index.html"), 
      asp=1,
      col=c("white", "black"), 
      axes=FALSE,
      xlab="", ylab="")
...
The authors want to thank Prof. Dr. Raul Blas Sevillano from UNALM, for his advice and support during the project. The  students Ana Lucia Ortega and Miguel Palacios from UNALM and Blander Mamani and Maritza Salazar from UNAP for their help in the experiments development, and to the farmers that made possible these project and KWS seed company for the funds for the project and my fellowship for my doctoral studies.
